...
<body><div class="card">
    ...
    <p>The action could not be completed — this may be because the item was already cancelled, the status has changed, or a required condition wasn't met.</p>
    <div class="actions">
